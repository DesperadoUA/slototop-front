...
<script>
   ...
   import app_main_banner from '~/components/main-banner/app-main-banner'
...
export default {
    ...
    app_content, app_new_casino, app_popular_slots, app_popular_offers, app_new_games, app_main_banner, app_bonuses_casino},
