                 ...
                 for(let i = counter * postsOnQuery; i<length; i++) {
                     html += `<div class="review-item">
                                <div class="review-item__author">
                                    <span itemprop='name'>${posts[i].review_name}</span>
                                </div>
                                <div class="review-item__rating">
                                    <div class="star-rating">
                                        <div class="star-rating__val" style="width: ${posts[i].review_rating}%"></div>
                                    </div>
                                    <strong class="slot-item__stats-val">${(posts[i].review_rating/10).toFixed(1)}/10</strong>
                                </div>
