<template>
   <div class="search">
        <button type="button" class="btn-default search__cta" @click="searchActivate">
            <svg class="search__icon" width="19" height="19" viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg">
                <circle cx="9.0366" cy="8.96684" r="4.72727" transform="rotate(-45 9.0366 8.96684)" stroke="#0D2342" stroke-width="2"/>
                <rect x="11.9292" y="13.0166" width="1.63636" height="4.90909" rx="0.818182" transform="rotate(-45 11.9292 13.0166)" fill="#0D2342"/>
            </svg>
        </button>
