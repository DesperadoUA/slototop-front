...
<div class="casino-card">
    <div class="container casino-card__container">
        <div class="casino-card__logo">
            <amp-img :src="value.casino[0].thumbnail" :alt="value.casino[0].title" width="210" height="140" />
        </div>
        ...
        <div class="casino-card__cta">
            <a class="casino-card__cta btn-primary"
            :href="getRef(value)" v-if="value.close === 0">
            ...
            <NuxtLink :to="`${config.AMP_PREFIX}${value.casino[0].permalink}`" class="casino-card__cta_permalink">
